...
def main():
    ...
    ap.add_argument("--src_roots", type=int, default=20, help="SRC root node numbers to try")
    ## For ORC params
    ...
    tasks = list(product(methods, ratios, range(args.src_roots)))
    ...
    rows: List[Dict[str, Any]] = Parallel(n_jobs=-1, backend="loky")(
        ...
        for method, ratio, src_root in tasks
    )
